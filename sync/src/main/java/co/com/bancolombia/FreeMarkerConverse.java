...
@Service
@AllArgsConstructor
public class FreeMarkerConverse implements ConverseDataGatewayAsync {
    ...
    @Override
    public <T> Mono<T> convertTOJSON(String xml, Context businessHeader, Class<T> target) {
    ...
    @Override
    public Mono<String> convertToXML(BusinessMessage businessMessage) {
